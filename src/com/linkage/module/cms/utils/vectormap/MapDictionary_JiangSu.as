package com.linkage.module.cms.utils.vectormap
{
	...
	public class MapDictionary_JiangSu extends MapDictionary
	{
		private var log:ILogger = Log.getLoggerByClass(MapDictionary_JiangSu);
		public function MapDictionary_JiangSu(configBaseUrl:String)
		{
			super(configBaseUrl);
		}
...
//			log.debug("[doInit]");
			...
			XML_URL = configBaseUrl+"map_nanjing.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0100"); 
			...
			XML_URL = configBaseUrl+"map_suzhou.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0200");
			...
			XML_URL = configBaseUrl+"map_wuxi.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0300");
			...
			XML_URL = configBaseUrl+"map_changzhou.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0400");
			...
			XML_URL = configBaseUrl+"map_zhenjiang.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0500");
			...
			XML_URL = configBaseUrl+"map_yangzhou.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0600");
			...
			XML_URL = configBaseUrl+"map_nantong.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0700");
			...
			XML_URL = configBaseUrl+"map_taizhou.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0800");
			...
			XML_URL = configBaseUrl+"map_xuzhou.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"0900");
			...
			XML_URL = configBaseUrl+"map_huaian.xml";
			//				MapDictionary.addMapBean(VcetorArr,cityMapping,XML_URL,"淮安");
			addMapBean(VcetorArr,cityMapping,XML_URL,"1000");
			...
			XML_URL = configBaseUrl+"map_yancheng.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"1100");
			...
			XML_URL = configBaseUrl+"map_lianyungang.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"1200");
			...
			XML_URL = configBaseUrl+"map_suqian.xml";
			addMapBean(VcetorArr,cityMapping,XML_URL,"1300");
