package com.linkage.module.cms.oneline.serv.wireless
{
	 ...
	 *
	 */
	public class GisHotHistoryGisInfoDataCMD
	{
		...
		public function execute(e:GisHotEvent):AsyncToken
		{
			...
			log.debug(e.param);
			return dao.getHotHistoryGisInfo(e.param);
		}
		...
		{
			log.error("[查询历史热点GIS点信息数据]失败：" + f.faultString + "::" +f.faultDetail);
