package com.linkage.module.cms.scenedaily.view.components.hangandpick
{
	 ...
	 *
	 */
	public class HangMedalDetailPM
	{
		 ...
		 * 获取挂牌网元基本信息
		 */
		public function getHangMedalnfo(id:String):void
		{
			var e:GedalDetailEvent = new GedalDetailEvent(GedalDetailEvent.GET_HANG_DETAIL_INFO);
			e.id = id;
			msgDispatcher(e);
		}
