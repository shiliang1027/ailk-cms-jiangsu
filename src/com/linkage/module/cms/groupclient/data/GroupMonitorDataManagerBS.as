package com.linkage.module.cms.groupclient.data
{
	...
	public class GroupMonitorDataManagerBS implements GroupMonitorDataManager
	{
		...
		public function getServerDataByCustom(param:Object,success:Function,complete:Function=null,error:Function=null):void{
			var remoteService:RemoteObject=BlazeDSUtil.newService(DESTINATION, SOURCE, endpoint, function(result:Object):void
			{
				success.call(null, result);
			}, function(event:FaultEvent):void
			{
				log.error(event.message.toString());
				error.call(null, event);
			}, true, "getServerDataByCustom");
			remoteService.getServerDataByCustom(param);
		}
		...
		public function saveGroupCustomerInfo(param:Object,success:Function,complete:Function=null,error:Function=null):void{
			var remoteService:RemoteObject=BlazeDSUtil.newService(DESTINATION, SOURCE, endpoint, function(result:Object):void
			{
				success.call(null, result);
			}, function(event:FaultEvent):void
			{
				log.error(event.message.toString());
				error.call(null, event);
			}, true, "saveGroupCustomerInfo");
			remoteService.saveGroupCustomerInfo(param);
		}
