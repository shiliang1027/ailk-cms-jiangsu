package com.linkage.module.cms.general.monitor.base.core.element.renderer
{
	 ...
	 *
	 */
	public class OppositeTriangleRenderer extends AreaMarkRenderer
	{
		public function OppositeTriangleRenderer(e:IElement)
		{
			super(e);
		}
		...
		override protected function drawShape(triangle:IAreaMark):void
		{
			...
			// 画三角形
			g.moveTo(0, 0);
			g.lineTo(triangle.width, 0);
			g.lineTo(triangle.width / 2, triangle.height);
			g.lineTo(0, 0);
			g.endFill();
		}
	}
