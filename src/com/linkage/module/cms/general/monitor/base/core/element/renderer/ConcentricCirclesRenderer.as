package com.linkage.module.cms.general.monitor.base.core.element.renderer
{
	 ...
	 *
	 */
	public class ConcentricCirclesRenderer extends AreaMarkRenderer
	{
		public function ConcentricCirclesRenderer(e:IElement)
		{
			super(e);
		}
		...
		override protected function drawShape(circle:IAreaMark):void
		{
			...
			g.drawCircle(circle.width / 2, circle.height / 2, radius-3);
			g.endFill();
		}
	}
}