...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">	
    ...
    <head>
        ...
        <script type="text/javascript">
        	...
        	{
        		document.getElementById('MapChoose').showEditData(data);
        	}
            ...
            var attributes = {};
            attributes.id = "MapChoose";
            attributes.name = "MapChoose";
            attributes.align = "middle";
            swfobject.embedSWF(
                "/cms/flex-release/MapChoose.swf", "flashContent", 
                "100%", "100%", 
    ...
    <body>
        ...
        <div id="flashContent">
       	...
       	<noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="MapChoose">
                <param name="movie" value="/cms/flex-release/MapChoose.swf" />
                ...
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="MapChoose.swf" width="100%" height="100%">
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />
                    <param name="allowScriptAccess" value="sameDomain" />
                    <param name="allowFullScreen" value="true" />
