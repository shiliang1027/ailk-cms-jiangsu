package com.linkage.module.cms.specialty.alarmSearch.common
{
	...
	public class TreeCheckBoxRenderer extends AdvancedDataGridGroupItemRenderer
	{
		 ...
		 *日志记录器
		 */
		private var log:ILogger=Log.getLogger("com.linkage.module.cms.specialty.alarmSearch.common.TreeCheckBoxRenderer");
		/**
		 *复选框
		 */
		...
		public static var setAlarmSelected:Function;
