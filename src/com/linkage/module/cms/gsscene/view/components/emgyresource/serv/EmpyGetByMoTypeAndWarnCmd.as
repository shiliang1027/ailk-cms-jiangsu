package com.linkage.module.cms.gsscene.view.components.emgyresource.serv
{
	 ...
	 *
	 */
	public class EmpyGetByMoTypeAndWarnCmd
	{
		private var log:ILogger = Log.getLoggerByClass(EmpyGetByMoTypeAndWarnCmd);
		...
		{
			return dao.getBadNeListByMoTypeAndWarnLevel(e.data);
		}
