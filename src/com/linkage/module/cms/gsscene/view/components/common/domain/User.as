package com.linkage.module.cms.gsscene.view.components.common.domain
{
	...
	public class User implements IUser
	{
		...
		private var _kpiGatherTime:String;
		...
		private var _logicalType:String;//场景逻辑类型（包含网元逻辑，2014-6-19，汪炜）
		
		private var _isGisFlag:String; // 1 :是gis定位  0 ：不是gis定位
		
		private var _refreshTime:String; // 刷新时间
		...
		public function get kpiGatherTime():String
		{
			return _kpiGatherTime;
		}

		public function set kpiGatherTime(value:String):void
		{
			_kpiGatherTime = value;
		}
		...
		public function get logicalType():String
		{
			return _logicalType;
		}
		
		public function set logicalType(value:String):void
		{
			_logicalType = value;
		}

		public function getImportParams():String{
			var params:String = "logicalType=" + this.logicalType;
		...
		public function getImportParamsForRemoteObject(param:Object):void{
			param.level = this.level;
			param.logicalType = this.logicalType;
			param.sceneTypeId = this.sceneTypeId;
