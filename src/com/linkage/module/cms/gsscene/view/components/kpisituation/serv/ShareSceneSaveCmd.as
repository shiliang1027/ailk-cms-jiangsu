package com.linkage.module.cms.gsscene.view.components.kpisituation.serv
{
	 ...
	 *
	 */
	public class ShareSceneSaveCmd
	{
		private var log:ILogger = Log.getLoggerByClass(ShareSceneSaveCmd);
		...
		public function execute(e:KPISituationEvent):AsyncToken
		{
			...
			return scenePanelDao.saveShareScene(e.param);
		}
		...
		public function result(data:Object):void
		{
			...
			var e:KPISituationEvent = new KPISituationEvent(KPISituationEvent.CMS_SCENE_KPISITUATION_SHOW_SHARE_SCENE_SAVE_RESULT);
