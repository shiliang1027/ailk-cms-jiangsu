package com.linkage.module.cms.gsscene.view.components.mapvector.util
{
	...
	public class XinJiangMapDictionary
	{
		 ...
		 * 默认加载的矢量图，全省名称
		 * */
		private static var provinceName = "新疆";
		private static var provinceId = "00";
		...
		private static function init():void{
			if(null==mapDic){
				...
				cityMapping["1500"] = "塔城";
				cityMapping["1600"] = "和田";
				XML_URL = "xml/map_xinjiang.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,cityMapping,XML_URL,XinJiangMapDictionary.provinceId);
				...
				XML_URL = "xml/xinjiang/map_akesu.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0800");
				...
				XML_URL = "xml/xinjiang/map_aletai.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"1400");
				...
				XML_URL = "xml/xinjiang/map_bazhou.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0600");
				...
				XML_URL = "xml/xinjiang/map_bozhou.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"1000");
				...
				XML_URL = "xml/xinjiang/map_changji.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0500");
				...
				XML_URL = "xml/xinjiang/map_hami.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0200");
				...
				XML_URL = "xml/xinjiang/map_hetian.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"1600");
				...
				XML_URL = "xml/xinjiang/map_kashi.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0900");
				...
				XML_URL = "xml/xinjiang/map_kelamayi.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0300");
				...
				XML_URL = "xml/xinjiang/map_kezhou.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"1100");
				...
				XML_URL = "xml/xinjiang/map_shihezi.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0400");
				...
				XML_URL = "xml/xinjiang/map_tacheng.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"1500");
				...
				XML_URL = "xml/xinjiang/map_tulufan.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0700");
				...
				cityMapping["000101"] = "";
				XML_URL = "xml/xinjiang/map_wulumuqi.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"0100");
				...
				XML_URL = "xml/xinjiang/map_yili.xml";
				XinJiangMapDictionary.addMapBean(VcetorArr,VcetorArr,XML_URL,"1200");
			}
		}
