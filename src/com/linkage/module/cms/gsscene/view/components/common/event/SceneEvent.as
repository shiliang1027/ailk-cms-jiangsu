package com.linkage.module.cms.gsscene.view.components.common.event
{
    ...
    public class SceneEvent extends Event
    {
		...
		//点击tree的地市区县级别视图，切换地图，并抛出change_vector_mapview事件
		public static const CHANGE_VECTOR_MAPVIEW:String = "CHANGE_VECTOR_MAPVIEW";
		...
		//直接撒点网元（日常节假日，lte场景下，不先到区域）
		public static const SAMPLE_MAP_CHANGE:String = "SAMPLE_MAP_CHANGE";
		//图层显示。
		public static const GISLAYER_CHANGE:String = "GISLAYER_CHANGE";
		
		
		
		
		//加载gis视图下，当前省市的退服情况，分gms，td，lte
		public static const LOAD_GIS_QUIT_NUM:String = "LOAD_GIS_QUIT_NUM";
		public static const SHOW_GIS_QUIT_NUM:String = "SHOW_GIS_QUIT_NUM";
