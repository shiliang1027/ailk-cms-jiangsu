package com.linkage.module.cms.gsscene.view.components.kpisituation.serv
{
	 ...
	 *
	 */
	public class KPIHistoryTopNChartCmd
	{
		private var log:ILogger = Log.getLoggerByClass(KPIHistoryTopNChartCmd);
		...
		public function execute(e:KPISituationEvent):AsyncToken
		{
			...
			log.info(user);
			return scenePanelDao.getMoKpiHisByKpiId(user);
		}
		...
		public function result(data:Object):void
		{
			...
			log.debug("[指标详情]:抛出处理历史topn趋势事件 －－－指标趋势：SHOW_HISTORY_TOPN_LINE_DATA");
			var kpiChartEvent:KPISituationEvent = new KPISituationEvent(KPISituationEvent.SHOW_HISTORY_TOPN_LINE_DATA);
