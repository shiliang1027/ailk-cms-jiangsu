package com.linkage.module.cms.gsscene.view.components.emgyresource
{
	...
	public class EmgyResourceDM
	{
		...
		private var _emgyCarTotal:ArrayCollection = new ArrayCollection;
		private var _emgyResourceDetail:ArrayCollection = new ArrayCollection;

		public function get emgyCarTotal():ArrayCollection
		{
			return _emgyCarTotal;
		}

		public function set emgyCarTotal(value:ArrayCollection):void
		{
			_emgyCarTotal = value;
		}
