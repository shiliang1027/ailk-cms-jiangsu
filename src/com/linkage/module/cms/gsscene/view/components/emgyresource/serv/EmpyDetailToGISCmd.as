package com.linkage.module.cms.gsscene.view.components.emgyresource.serv
{
	 ...
	 *
	 */
	public class EmpyDetailToGISCmd
	{
		private var log:ILogger = Log.getLoggerByClass(EmpyDetailToGISCmd);
		...
		public function result(data:Object):void
		{
			...
			log.debug(data);
			this.emgyResourceDM.emgyCarTotal.removeAll();
			this.emgyResourceDM.emgyCarTotal.addAll(data as IList);
			this.emgyResourceDM.emgyCarTotal.refresh();
			log.debug(emgyResourceDM.emgyCarTotal);
			msgDispatcher(new EmpyEvent("LOAD_EMPY_TO_GIS_SUCC"));
			log.debug("LOAD_EMPY_TO_GIS_SUCC");
