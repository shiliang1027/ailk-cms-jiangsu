package com.linkage.module.cms.gsscene.view.components.common.domain
{
	...
	public interface IUser
	{
		...
		//刷新时间。
		function get refreshTime():String;
		function set refreshTime(value:String):void;
		...
		function get kpiGatherTime():String;
		function set kpiGatherTime(value:String):void;
		...
		function get logicalType():String;
		function set logicalType(value:String):void;
		
		/**
		 *获取场景的基本关键信息
		 * */
		function getImportParams():String;
		/**
		 *获取场景的基本关键信息
		 * */
		function getImportParamsForRemoteObject(params:Object):void;
