...
//			if ((user.showMoLayer == "0" && user.level != "1") || user.level == "3" || user.level == "2")
			if ((user.showMoLayer == "0" && user.level != "1") || user.level == "2")
            {
...
//            msgDispatcher(e);
		...
		public function loadMapGisQuitInfo():void
		{
			log.info("加载基站总数和退服总数:");
			var e:SceneEvent = new SceneEvent(SceneEvent.LOAD_GIS_QUIT_NUM);
//			msgDispatcher(e);
			requestServerUtil.addRequest(e);
		}
    }
