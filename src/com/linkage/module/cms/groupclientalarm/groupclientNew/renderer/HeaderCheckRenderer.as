package com.linkage.module.cms.groupclientNew.renderer
{
	...
	public class HeaderCheckRenderer extends AdvancedDataGridHeaderRenderer
	{
		 ...
		 *日志记录器
		 */
		private var log:ILogger=Log.getLogger("com.linkage.module.cms.groupclientNew.renderer.HeaderCheckRenderer");
		/**
		 *全选按钮
		 */
