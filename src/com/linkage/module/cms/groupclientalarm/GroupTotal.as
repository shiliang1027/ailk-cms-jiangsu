...
import com.linkage.module.cms.groupclientalarm.components.NormalWindow;
import com.linkage.module.cms.groupclientalarm.control.GroupTotalModuleControl;
...
protected function sheetWindow_initHandler(event:SheetWindowEvent):void
{
	control.sheetWindowInit();
}
protected function sheetWindow_sheetdetailShowHandler(event:SheetWindowEvent):void
{
	control.sheetDetailWindow(event.param);
}
protected function sheetWindow_sheetdetailSendShowHandler(event:SheetWindowEvent):void
{
	control.sheetDetailSendWindow(event.param);
}
...
protected function servWindow_exportDataHandler(event:ServWindowEvent):void
{
	control.exportAlarmListShow(event.param);
}
...
protected function sheetWindow_pageGoHandler(event:SheetWindowEvent):void
{
	control.sheetWindowPageChange(event.param);
}

protected function sheetWindow_sheetShowHandler(event:ServWindowEvent):void
{
...
protected function custAlarmListWindow_custAlarmExpottHandler(event:CustAlarmWindowEvent):void
{
	control.custAlarmExport();
}
...
protected function custAlarmListWindow_AlarmExprotHandler(event:AlarmListWindowEvent):void
{
	control.alarmExport();
}
