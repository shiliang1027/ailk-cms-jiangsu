...
//		private static const DESTINATION:String="flexdestination_cms_groupcustom_total_totalservice";
		private static const DESTINATION:String="flexdestination_cms_groupsupport_alarm_general_generalservice";
		...
		public function getSheetInfo(param:Object,success:Function,complete:Function=null,error:Function=null):void{
			var remoteService:RemoteObject=BlazeDSUtil.newService(DESTINATION, SOURCE, endpoint, function(result:Object):void
			{
				log.info("getSheetInfo");
				log.info(result);
				success.call(null, result);
			}, function(event:FaultEvent):void
			{
			...
			remoteService.getSheetInfo(param);
		}
		public function getSheetDetail(param:Object,success:Function,complete:Function=null,error:Function=null):void{
			var remoteService:RemoteObject=BlazeDSUtil.newService(DESTINATION, SOURCE, endpoint, function(result:Object):void
			{
				success.call(null, result);
			}, function(event:FaultEvent):void
			...
			remoteService.getSheetDetail(param);
		}
		public function sendMsg(param:Object,success:Function,complete:Function=null,error:Function=null):void{
			var remoteService:RemoteObject=BlazeDSUtil.newService(DESTINATION, SOURCE, endpoint, function(result:Object):void
			{
				success.call(null, result);
			}, function(event:FaultEvent):void
			...
			remoteService.sendMsg(param);
		}
		public function getSheetPageData(param:Object,success:Function,complete:Function=null,error:Function=null):void{
			var remoteService:RemoteObject=BlazeDSUtil.newService(DESTINATION, SOURCE, endpoint, function(result:Object):void
			{
				success.call(null, result);
			}, function(event:FaultEvent):void
			{
				log.error(event.message.toString());
				error.call(null, event);
			}, true, "getSheetPageData");
			remoteService.getSheetPageData(param);
		}
	}
