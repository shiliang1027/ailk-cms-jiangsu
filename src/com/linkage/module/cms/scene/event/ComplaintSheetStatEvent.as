package com.linkage.module.cms.scene.event
{
    ...
    public class ComplaintSheetStatEvent extends Event
    {
        ...
        public static const LOAD_COMPLAINTSHEET_DATA_MOTYPE:String = "LOAD_COMPLAINTSHEET_DATA_MOTYPE";
        public static const LOAD_COMPLAINTSHEET_DATA_MOTYPE_SUCC:String = "LOAD_COMPLAINTSHEET_DATA_MOTYPE_SUCC";
