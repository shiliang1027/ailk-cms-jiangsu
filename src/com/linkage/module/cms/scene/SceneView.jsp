...
<script type="text/javascript">            var swfVersionStr = "10.0.0";
			...
			flashvars.moduleUrl="<s:url value='/flex-release/com/linkage/module/cms/scene/SceneModule.swf'/>";
            ...
            flashvars.sceneId = "<s:property value='params.sceneId'/>";
            flashvars.sceneTypeId = "<s:property value='params.sceneTypeId'/>";
            flashvars.showMoLayer = "<s:property value='params.showMoLayer'/>";
            flashvars.mapType = "<s:property value='params.mapType'/>";
            flashvars.usinglayer = "<s:property value='params.usinglayer'/>";
            flashvars.layerurl = "<s:property value='params.layerurl'/>";
            flashvars.layerid = "<s:property value='params.layerid'/>";
            flashvars.isNew = "<s:property value='params.isNew'/>";
            flashvars.newAdded = "<s:property value='params.newAdded'/>";
            flashvars.sceneAreaid = "<s:property value='params.sceneAreaid'/>";
 flashvars.pointlatitude = "<s:property value='params.pointlatitude'/>";
 flashvars.pointlongitude = "<s:property value='params.pointlongitude'/>";
            
            
            flashvars.level = "1";
            flashvars.LogLevel="debug";
            flashvars.LogType="1"
						flashvars.LogFilters="com.linkage.module.cms.scene.*";
