package com.linkage.module.cms.baseline.static.renderer
{
	...
	public class CheckBoxSelectHeaderRenderer extends AdvancedDataGridHeaderRenderer
	{
		 ...
		 *日志记录器
		 */
		private var log:ILogger=Log.getLogger("com.linkage.module.cms.baseline.static.renderer.HeaderCheckRenderer");
		/**
		 *全选按钮
		 */
