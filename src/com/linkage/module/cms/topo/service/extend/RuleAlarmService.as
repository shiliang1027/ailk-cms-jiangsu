package com.linkage.module.cms.topo.service.extend
{
	...
	public class RuleAlarmService extends AbstractAlarmRefService
	{
		private var log:ILogger = Log.getLoggerByClass(AllAlarmService);
		// 数据源
		private var _dataSource:IDataSource = null;
		public function RuleAlarmService(dataSource:IDataSource)
		{
			super();
		...
		override protected function loadTopoLayerAlarms(topoLayer:TopoLayer):Boolean
		{
			...
			var loadAlarmTag:String = topoLayer.topoId + ":" + topoLayer.topoViewName + "@default-topo-ltep2p";
			...
			params.topoName="default-topo-ltep2p";
