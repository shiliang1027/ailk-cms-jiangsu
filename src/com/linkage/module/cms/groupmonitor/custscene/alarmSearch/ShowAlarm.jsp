...
<html>	
    ...
    <head>
		...
		<%
			...
			String module_key = request.getParameter("module_key");
			String dalTime = request.getParameter("dalTime");
		%>
        ...
        <script type="text/javascript">
            ...
            flashvars.moduleUrl="<s:url value='/flex-release/com/linkage/module/cms/groupmonitor/custscene/alarmSearch/ShowAlarmModule.swf'/>";
            flashvars.alarmuniqueid = '<%=alarmuniqueid %>';
            flashvars.module_key = '<%=module_key %>';
            flashvars.dalTime = '<%=dalTime %>';
        ...
        <div id="flashContent">
       	...
       	<noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="ShowAlarmList">
                <param name="movie" value="/cms/flex-release/ShowAlarm.swf" />
                ...
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="ShowAlarm.swf" width="100%" height="100%">
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />
                    <param name="allowScriptAccess" value="sameDomain" />
                    <param name="allowFullScreen" value="true" />
