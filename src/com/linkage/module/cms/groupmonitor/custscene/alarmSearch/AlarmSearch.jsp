...
<html >	
        ...
        <script type="text/javascript">
			...
			function export2Excel(url, data, type)
			{
				if(type == "1")
				{
					...
					document.getElementById('clentLevel').value=data.clentLevel;
					document.getElementById('businessType').value=data.businessType;
					document.getElementById('groupcustomerNum').value=data.groupcustomerNum;
					document.getElementById('groupcustomerNumFlag').value=data.groupcustomerNumFlag;
					document.getElementById('pduSign').value=data.pduSign;
					document.getElementById('pduSignFlag').value=data.pduSignFlag;
            ...
            flashvars.moduleUrl="<s:url value='/flex-release/com/linkage/module/cms/groupmonitor/custscene/alarmSearch/AlarmSearchModule.swf'/>";
            var params = {};
            params.quality = "high";
    ...
    <body>
    	<form action="" method="post" name="exportFrm" id="exportFrm"  style="display:none">
    		...
    		<input type="hidden" name="groupcustomerNum" id=groupcustomerNum/>
    		<input type="hidden" name="groupcustomerNumFlag" id=groupcustomerNumFlag/>
    		<input type="hidden" name="pduSign" id=pduSign/>
    		<input type="hidden" name="pduSignFlag" id=pduSignFlag/>
    		<input type="hidden" name="clentLevel" id=clentLevel/>
