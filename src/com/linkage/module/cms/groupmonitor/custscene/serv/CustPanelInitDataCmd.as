...
//	import com.linkage.module.cms.general.regional.mss.controller.MsgAction;
	 ...
	 *
	 */
	public class CustPanelInitDataCmd
	{
		private var log:ILogger=Log.getLoggerByClass(CustPanelInitDataCmd);
		...
		public function result(data:Object):void
		{
			...
			dm.panelRightList.addAll(data.city as IList);
			dm.panelRightList.refresh();
			//dispatchMsg(new CustSceneEvent(CustSceneEvent.CUST_PANEL_INIT_DATA_COMP))
		}
